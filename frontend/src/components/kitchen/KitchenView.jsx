        ...
        <div>
          ...
          <div className="table-header">
            <div className="table-info">
              ...
              {selectedLocation && (
                <span> — {LOCATION_LABELS[selectedLocation] || selectedLocation}</span>
              )}
              ...
              {(favorites.length > 0 || extraEmployees.length > 0) && (
                <span className="stat">
                  {' '}| Fav: {favorites.length} | Нэмэлт: {extraEmployees.length}
                </span>
              )}
            </div>
            ...
            <div className="table-header-actions">
              <button
                ...
                onClick={() =>
                  setSelectedEmployeeIds(
                    sortedFilteredEmployees.filter((e) => !e.is_swiped).map((e) => e.id),
                  )
                }
              >
                Бүгд
          ...
          {/* Submit / save shift buttons */}
          {visibleSelectedCount > 0 && (
            <div className="submit-actions">
              <button type="button" className="submit-btn" onClick={submitOrder}>
                Захиалга илгээх ({visibleSelectedCount} ажилтан)
              </button>
